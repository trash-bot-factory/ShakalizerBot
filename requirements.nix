...
#
# COMMAND:
#   pypi2nix -V 3 -e pytelegrambotapi -e pillow -E pkgconfig zlib libjpeg openjpeg libtiff freetype lcms2 libwebp tcl
#
...
let
  ...
  generated = self: {
    ...
    "pyTelegramBotAPI" = python.mkDerivation {
      name = "pyTelegramBotAPI-3.5.1";
      src = pkgs.fetchurl { url = "https://pypi.python.org/packages/b6/64/40fdf425f6d3cf108cb9c196ed81bfe388f69359194a0362482607b3ef29/pyTelegramBotAPI-3.5.1.tar.gz"; sha256 = "d097128ab2c6b43a0219231a4b39da46e3f2960cd8415ad0913c752e335cc4a8"; };
      doCheck = commonDoCheck;
      buildInputs = commonBuildInputs;
      propagatedBuildInputs = [
      self."requests"
